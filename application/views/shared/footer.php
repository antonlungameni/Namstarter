...
<footer style="background-color: rgb(221,51,51);">
    ...
    <div class="medium-12 columns large-12 small-12 end_page" style="background-color: rgb(221,51,51);">
        ...
        <ul class="menu pull-right">
            <li class="menu-text menu-centered" style="padding-bottom: 10px;">Copyright RLabs Namibia <?= date('Y'); ?> &copy;</li>
        </ul>
    </div>
</footer>
</div>
